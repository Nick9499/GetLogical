    ...
    <div className="mt-20">
      <div className="flex flex-col md:grid md:grid-cols-3 md:gap-x-24  lg:gap-x-20 lg:px-20 md:pb-10  bg-[#333] text-white px-10  ">
        <div className="pt-10">
          ...
          <div className="pt-3 flex justify-between">
            <IconButton
              onClick={() =>
                window.open(
                  "https://www.facebook.com/Turbo-Offers-106717794700388"
                )
              }
              variant="text"
            ...
            <IconButton
              onClick={() =>
                window.open("https://www.instagram.com/myturbooffer/")
              }
              variant="text"
              className="text-white">
              <svg
            ...
            <IconButton
              onClick={() => window.open("https://www.twitter.com/turbooffers")}
              variant="text"
              className="text-white">
              <svg
                className="h-8 w-8"
        ...
        <div className="flex flex-col pt-10 pb-5">
          <Typography className="pb-3">Contact Us</Typography>
          <a className="pb-1" href="mailto:support@helpgrid.com">
            {" "}
            support@helpgrid.com
          </a>
          <Typography className="pb-1">
            {" "}
            +44 1704 320446 | +1 302-200-4456
          </Typography>
          <Typography className="pb-1">
            1201 N Orange ST STE 7212, Wilmington, DE 19801, United States
          </Typography>
        </div>
      </div>

      <div className="bg-[#252424] flex justify-center text-white p-2  ">
        <Typography>
          ©{new Date().getFullYear()} GetLogicall. All rights reserved.
        </Typography>
      </div>
    </div>
  );
